...
const data = [
    {
        ...
        Description: `Daily and weekly weather data from the darksky API`,
        CourseLink: ``,
        LiveDemo: `https://jonathans-weather-app.herokuapp.com/`,
        keyPoints: [
        ...
        keyPoints: [
            'HTML', 'DOM', 'JavaScript', 'Event Listeners'
        ],
        ...
        keyPoints: [
            'HTML', 'CSS', 'Layout', "Box Model", "Media Queries"
        ],
        bgColorTop: `rgba(119, 153, 134, 0.3)`,
        ...
        keyPoints: [
            'HTML', 'CSS', "DOM", "Event Listeners", "Forms"
        ],
        bgColorTop: `rgba(119, 153, 134, 0.3)`,
        bgColorBottom: `rgba(135, 71, 51, 1)`,
